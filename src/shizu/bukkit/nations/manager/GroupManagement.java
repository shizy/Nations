...
/**
 * Manages instances of the Group class and their interactions between the
...
public class GroupManagement extends Management
{
	 ...
	 * 
	 * @param key
	 *            The group name of the Group to get
	...
	/**
	 * Creates a nation Group for the commanding User and sets them in a
	 * position of leadership for that Group.
	 * 
	 * @param user
	 *            The User creating the nation Group
	 * @param name
	 *            The name of the new nation Group
	...
	public Boolean foundNation(User user, String name)
	{
		...
		if (!exists(name))
		{
			...
			if (user.getNation().equals(""))
			{
				...
				saveObject(name);
				plugin.messageAll("The Nation of '" + name
						+ "' has been founded!");
				return true;
			} else
			{
	...
	/**
	 * Renames a nation and updates the ownership info for all members and plots
	 * in the nation.
	 * 
	 * @param user
	 *            The commanding user
	...
	public Boolean renameNation(User user, String name)
	{
		...
		if (!user.getNation().equals(""))
		{
			...
			if (nation.hasLeader(user.getName()))
			{
				...
				plugin.messageAll("The Nation of '" + user.getNation()
						+ "' is now the Nation of '" + name + "'!");
	...
	public Boolean setTaxRate(User user, int rate)
	{
		...
		if (!user.getNation().equals(""))
		{
			...
			if (nation.hasLeader(user.getName()))
			{
				...
				nation.setTax(rate);
				messageGroup(nation.getName(), GroupMemberType.MEMBERS, "The " + user.getNation()
	 ...
	 * 
	 * @param user
	 *            The User changing the diplomacy of his nation
	 * @param nation
	 *            The Nation the user wants to change his diplomacy with
	 * @param status
	 *            The status of the diplomatic relationship (ally, neutral,
	 *            enemy)
	 */
	 ...
	 * 
	 * @param user
	 *            The User that is promoting the member.
	 * @param promoted
	 *            The User that is being promoted
	 */
	 ...
	 * 
	 * @param user
	 *            The User that is demoting the leader.
	 * @param promoted
	 *            The User that is being demoted
	 */
